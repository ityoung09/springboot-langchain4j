...
public class AiGroupByChatIdPersistentStoreConfig {
    ...
    @Bean
    public AiGroupByChatIdStoreConfig.Assistant groupByChatIdPersistentAssistant(@Qualifier("qwenChatModel") ChatLanguageModel qwenChatModel, QwenStreamingChatModel qwenStreamingChatModel) {
        ...
        ChatMemoryProvider chatMemoryProvider = memoryId -> MessageWindowChatMemory.builder()
                ...
                .build();
        return AiServices.builder(AiGroupByChatIdStoreConfig.Assistant.class).chatLanguageModel(qwenChatModel)
